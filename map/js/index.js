...
function colorToBusMarker(color) {
  switch (color) {
    case 'green':
      return '/images/dashboard/car_green.png';
    case 'purple':
      return '/images/dashboard/car_purple.png';
    case 'red':
      return '/images/dashboard/car_red.png';
    case 'moover':
      return '/images/dashboard/moover.png';
    case 'moover_tugging':
      return '/images/dashboard/moover_tugging.png';
    default:
      console.log(`colorToBusMarker(${color}) not handled`);
      return '/images/dashboard/error.png';
  }
}
